...
class Caltech256ClassificationDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        try:
            ...
            img = Image.open('/kavesnin/delete_this/256_ObjectCategories/198.spider/198_0001.jpg').convert("RGB")
...
def main():
    ...
    model_path = 'model_triple_semi_hard_0_2_lr0_0001_proxy_0_5_lr0_001/model_epoch_2.pth'
